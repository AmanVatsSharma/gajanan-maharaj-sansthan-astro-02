...
When you call 7070604312 or message the Sansthan on WhatsApp at the same number, the booking desk will ask two things that determine what is allocated: (a) is there a senior citizen or divyang guest in the group, and (b) does that guest need a ground-floor room. Saying yes to both routes you to the rooms our office holds for accessibility, which are mostly Block 1 non-AC and a small set of Block 2 first-floor AC.
