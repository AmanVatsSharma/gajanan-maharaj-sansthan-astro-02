...
2. **2-5 H2 sections** covering the topic deeply. Each section:
   ...
   - References the Sansthan contact desk `7033516657` where relevant
...
- **Direct phone reference** to the Sansthan desk (`7033516657` for the Omkareshwar desk; for Trimbakeshwar, check `src/data/sansthan-data.ts`)
