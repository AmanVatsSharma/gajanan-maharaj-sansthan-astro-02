...
"Deluxe Suites (₹3,150) and Luxury Suites (₹4,150) at Bhakta Niwas Shegaon can be booked by contacting the Sansthan office via WhatsApp or phone at +917404984712. Use the booking form on our website to send your request, specifying the Deluxe or Luxury Suite preference, check-in date, and guest count. These rooms are limited and should be booked well in advance.",
  ...
  // --- WhatsApp & contact FAQs ---
  {
    ...
    answer:
      "The WhatsApp booking number for Shri Gajanan Maharaj Sansthan is +917404984712. You can send your accommodation booking request via WhatsApp with your preferred location, check-in date, check-out date, and number of guests. The Sansthan office will confirm availability and complete your booking.",
    category: "booking",
  },
  {
    id: "booking-by-phone",
    ...
    answer:
      "Yes, you can call the Sansthan booking helpline at +917404984712 to make an accommodation booking request. Office hours are Monday to Sunday, 9:00 AM to 6:00 PM. For convenience, WhatsApp booking is also available on the same number.",
    category: "booking",
  },
  {
  ...
  // --- Festival / peak season FAQs ---
  {
    ...
    answer:
      "For Ashadhi Ekadashi at Pandharpur, book your Bhakta Niwas accommodation at Shri Gajanan Maharaj Sansthan Pandharpur several months in advance. Contact the Sansthan office at +917404984712 via WhatsApp or call. Rooms fill up months before the Ekadashi date. The Sansthan provides accommodation near the Vitthal temple for warkari families visiting during the Ashadha wari.",
    category: "booking",
  },
  {
    ...
    answer:
      "For Kartik Ekadashi (Dev Uthani Ekadashi) at Pandharpur, advance booking at Shri Gajanan Maharaj Sansthan Pandharpur is essential — rooms book out quickly. Contact the Sansthan office at +917404984712 as early as possible, ideally 3–4 months before the Kartik Ekadashi date. The Sansthan provides family accommodation for Vitthal devotees visiting Pandharpur during the Kartik wari.",
    category: "booking",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Peak booking seasons at Shegaon Bhakta Niwas are: (1) Gajanan Vijay Utsav / Punyatithi (September 8 each year) — the busiest day, lakhs of devotees visit. (2) Ganesh Chaturthi (August–September). (3) Navratri (October). (4) Diwali (October–November). (5) Makar Sankranti (January 14). During these periods, rooms fill weeks to months in advance. Early WhatsApp booking at +917404984712 is strongly recommended.",
    category: "booking",
  },
  // --- Darshan & visit FAQs ---
  {
